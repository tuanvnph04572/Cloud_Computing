  ...
  <!-- 
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li  class="fh5co-active"><a href="QuanLySanPham.aspx">Quản lý sản phẩm</a></li>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
                <asp:DetailsView ID="DetailsView1" runat="server" Width="100%" AllowPaging="True" AutoGenerateRows="False" CellPadding="4" DataKeyNames="ProductId" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
