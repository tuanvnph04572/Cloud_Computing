	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<div class="row">
					<div class="col-md-5">
						<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Hóa đơn</span></h2>
						<asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="500px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaHD" DataSourceID="SqlDataSource1">
                            <Fields>
					    ...
					    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\QLBH.mdf;Integrated Security=True;Connect Timeout=30" DeleteCommand="DELETE FROM [HoaDon] WHERE [MaHD] = @MaHD" InsertCommand="INSERT INTO [HoaDon] ([MaHD], [NgayMua], [KhachHang_MaKH]) VALUES (@MaHD, @NgayMua, @KhachHang_MaKH)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [MaHD], [NgayMua], [KhachHang_MaKH] FROM [HoaDon]" UpdateCommand="UPDATE [HoaDon] SET [NgayMua] = @NgayMua, [KhachHang_MaKH] = @KhachHang_MaKH WHERE [MaHD] = @MaHD">
                            <DeleteParameters>
