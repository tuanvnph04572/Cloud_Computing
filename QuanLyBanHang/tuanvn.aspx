...
<head>
    ...
    <title>&copy; <%: DateTime.Now.Year %> - Nhom 8</title>
...
<body>
    <div id="fh5co-page">
        ...
        <aside id="fh5co-aside" role="complementary" class="border js-fullheight">
            ...
            <h1 id="fh5co-logo"><a href="Default.aspx">
                <img src="images/logo.png" alt="Free HTML5 Bootstrap Website Template"></a></h1>
            ...
            <div class="fh5co-footer">
                <p><small>&copy; <%: DateTime.Now.Year %> - Nhom 8</span></small></p>
                <ul>
