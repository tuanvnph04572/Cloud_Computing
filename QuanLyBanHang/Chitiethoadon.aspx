	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<div class="row">
					<div class="col-md-5">
						<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Chi tiết hóa đơn</span></h2>
						<asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="500px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaCTHD" DataSourceID="SqlDataSource1">
                            <Fields>
					    ...
					    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\QLBH.mdf;Integrated Security=True;Connect Timeout=30" DeleteCommand="DELETE FROM [ChiTietHoaDon] WHERE [MaCTHD] = @MaCTHD" InsertCommand="INSERT INTO [ChiTietHoaDon] ([MaCTHD], [DonGia], [SoLuong], [HoaDon_MaHD], [SanPham_MaSP]) VALUES (@MaCTHD, @DonGia, @SoLuong, @HoaDon_MaHD, @SanPham_MaSP)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [MaCTHD], [DonGia], [SoLuong], [HoaDon_MaHD], [SanPham_MaSP] FROM [ChiTietHoaDon]" UpdateCommand="UPDATE [ChiTietHoaDon] SET [DonGia] = @DonGia, [SoLuong] = @SoLuong, [HoaDon_MaHD] = @HoaDon_MaHD, [SanPham_MaSP] = @SanPham_MaSP WHERE [MaCTHD] = @MaCTHD">
                            <DeleteParameters>
